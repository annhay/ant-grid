...
const (
	Order_PickUp_FullMethodName      = "/stream.Order/PickUp"
	Order_CreateOrder_FullMethodName = "/stream.Order/CreateOrder"
	Order_OrderList_FullMethodName   = "/stream.Order/OrderList"
)
...
type OrderClient interface {
	PickUp(ctx context.Context, in *PickUpReq, opts ...grpc.CallOption) (*PickUpResp, error)
...
func (c *orderClient) PickUp(ctx context.Context, in *PickUpReq, opts ...grpc.CallOption) (*PickUpResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PickUpResp)
	err := c.cc.Invoke(ctx, Order_PickUp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	PickUp(context.Context, *PickUpReq) (*PickUpResp, error)
...
func (UnimplementedOrderServer) PickUp(context.Context, *PickUpReq) (*PickUpResp, error) {
...
func _Order_PickUp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PickUpReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).PickUp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Order_PickUp_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).PickUp(ctx, req.(*PickUpReq))
	}
